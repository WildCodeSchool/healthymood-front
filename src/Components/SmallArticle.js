  ...
  return (
    <>
      <div key={a.slug} className='small-article-global-container'>
        <Link to={`/recettes/${a.slug}`} key={a.slug} className='link-recette'>
          <div className='small-article-container'>
            <>
              <div
                className='small-article-banner-image'
                style={{
                  backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.1)), url(${a.image}`
                }}
              />
