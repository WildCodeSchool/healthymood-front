...
class RecipeToPrint extends React.Component {
  render() {
    ...
    console.log(recipeInfo.category[0].name);
    return (
      <div className="recipe-container">
        <header>
          ...
          <div className="publication-info">
            ...
            />
            <p>{/* {recipeInfo.user_id} */} HealthyMood</p>
            <span
              className="picto-container"
              style={{ backgroundImage: `url(${publishedImage})` }}
            />
            <p>{recipeInfo.preparation_duration_seconds} seconds</p>
            <span
              className="picto-container"
              style={{ backgroundImage: `url(${categoryImage})` }}
            />
            <p>{recipeInfo.category[0].name}</p>
          </div>
