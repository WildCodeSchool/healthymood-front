          ...
          {recipe &&
            recipe.map((r) => {
              return (
                <div
                  key={r.id}
                  className='small-recipe-global-container-user-page'
                >
                  <Link
                    to={`/recettes/${r.slug}`}
                    key={r.id}
                    className='link-recette-user-page'
                  >
                    <div className='small-recipe-container-user-page'>
                      <>
                        ...
                        <div className='small-recipe-content-container-user-page'>
                          <h1 className='small-recipe-title-user-page'>
                            {r.name}
                          </h1>
                          <p className='small-recipe-intro-user-page'>
                            {r.content}
                          </p>
